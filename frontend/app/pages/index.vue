...
<template>
  <div class="min-h-screen bg-paper font-body text-void relative overflow-hidden">
    <!-- Grain -->
    ...
    <!-- Marquee band -->
    <div class="relative w-full bg-volt border-y-[3px] border-void overflow-hidden py-2 -rotate-1 z-10">
    ...
    <div class="relative z-20 max-w-6xl mx-auto p-4 md:p-6">
      ...
      <!-- Inbox -->
      <div v-if="generated" class="flex flex-col md:flex-row gap-4 min-h-[450px]">
        <!-- Email List -->
        <div class="w-full md:w-80 flex-shrink-0">
          <div class="rounded-2xl border-[3px] border-void bg-paper shadow-chunky overflow-hidden h-full">
            <div class="border-b-[3px] border-void px-4 py-2 font-mono text-xs tracking-widest uppercase text-void/50 bg-base-200">
            ...
            <div v-else class="divide-y-[3px] divide-void max-h-[500px] overflow-y-auto hide-scrollbar">
              <div
        ...
        <div class="flex-1">
          <div class="rounded-2xl border-[3px] border-void bg-paper shadow-chunky h-full">
            ...
            <div v-else class="p-5 md:p-6">
              ...
              <h2 class="font-display font-black text-xl md:text-2xl leading-tight mb-3">{{ selectedEmail.subject }}</h2>
              ...
              <div v-if="selectedEmail.html" class="prose max-w-none text-sm font-body" v-html="selectedEmail.html"></div>
    ...
    <!-- Footer -->
    <div class="relative z-20 mt-8 border-t-[3px] border-void bg-void py-4">
